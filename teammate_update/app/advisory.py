...
from app.database import find_advisory
...
from app.risk import compute_final_risk
from app.weather_service import fetch_weather_snapshots
from app.llm_advisory_service import enrich_advisory_with_llm
